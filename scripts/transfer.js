module.exports = async () => {
  try {
    ...
    const uni_token = new web3.eth.Contract(
      UNI_ABI,
      "0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984"
    );

    const uni_amount = await uni_token.methods.balanceOf(account).call();
    console.log(uni_amount);
    console.log(account);
    console.log(await web3.eth.getBalance(account));
    // const tx = await uni_token.methods
    //   .transfer("0xad66c155993085c8d2a37409adeccf8436b40fff", uni_amount)
    //   .send({ from: account });
